...
function varargout = EpiTools_OutputFcn(~, ~, ~)
...
% valorised.
function createMenu(hObject,~,handles)
% Menu item
...
% --------------------------------------------------------------------
%% Menu Callbacks 
function E_Undo_Callback(~, ~, ~)
% --------------------------------------------------------------------
function E_Redo_Callback(~, ~, ~)
% --------------------------------------------------------------------
function E_Preferences_Callback(~, ~, ~)
...
UserSettingsGUI();
% --------------------------------------------------------------------
function F_New_Callback(hObject, ~, handles)
...
% --------------------------------------------------------------------
function F_Open_Callback(hObject, ~, handles)
...
% --------------------------------------------------------------------
function F_ImportSettings_Callback(hObject, ~, handles)
...
onMainWindowClose(hObject, eventdata, handles);
% --------------------------------------------------------------------
function V_D_SingleMode_Callback(hObject, ~, handles)
...
% --------------------------------------------------------------------
function V_D_ComparativeMode_Callback(hObject, ~, handles)
...
% --------------------------------------------------------------------
function V_D_DefaultInterface_Callback(~, ~, handles)
...
% --------------------------------------------------------------------
function uiIcyVisualizationToggle_OffCallback(hObject, ~, handles)
% hObject    handle to uiIcyVisualizationToggle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
use_icy_checkbox_Callback(0);
% --------------------------------------------------------------------
function uiIcyVisualizationToggle_OnCallback(hObject, ~, ~)
% hObject    handle to uiIcyVisualizationToggle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function uiExecuteServerQueue_ClickedCallback(~, ~, ~)
...
% --------------------------------------------------------------------
function uiManagePoolActivation_ClickedCallback(~, ~,~)
hMainGui = getappdata(0, 'hMainGui');
pool_instances = getappdata(hMainGui, 'pool_instances');
...
% --------------------------------------------------------------------
function uiFlushServerQueue_ClickedCallback(~, ~, ~)
...
% --------------------------------------------------------------------
function uiImageLayersToggle_OffCallback(~, ~, ~)
...
% --------------------------------------------------------------------
function uiImageLayersToggle_OnCallback(~, ~, ~)
% hObject    handle to uiImageLayersToggle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function callModule(hObject,~,handles,strModuleName)
obj = getappdata(getappdata(0, 'hMainGui'), 'settings_objectname');
client_modules = getappdata(getappdata(0, 'hMainGui'), 'client_modules');
clients = client_modules(2).ref;
% [2]
